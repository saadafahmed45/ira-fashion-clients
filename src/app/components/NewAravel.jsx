...
const NewAravel = async () => {
    ...
    return (
        <div>
            <div className='py-8'>
                <h2 className='text-4xl text-center'>New Aravel</h2>
            </div>
            <div className='grid grid-cols-4 items-center place-items-center gap-4 px-16'>
                {
                    newProducts.map((item => (
                        <div key={item._id} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow  ">
                            <a href="#">
                                <img
            ...
            <div className='text-center  py-6'>
                <Link href={'/product'} className=' bg-black text-white p-2 rounded'> See more product</Link>
            </div>
        </div>
    )
}
