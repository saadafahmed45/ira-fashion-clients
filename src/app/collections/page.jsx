      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {isLoading ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
            <p className="text-red-500 text-sm font-medium mb-4">Unable to load collections at this time.</p>
            <button
              onClick={() => refetch()}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-72 w-full overflow-hidden bg-gray-100">
                    ...
                    {/* Badge */}
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-md px-3 py-1 rounded-full text-[10px] uppercase font-bold tracking-widest text-[#111111] shadow-sm">
